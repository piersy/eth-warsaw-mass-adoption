      ...
      <div className="flex items-center flex-col flex-grow pt-10">
        ...
        <form className="space-y-4">
            <div>
              ...
              <input type="text" id="name" name="phone" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
            </div>
            <div>
